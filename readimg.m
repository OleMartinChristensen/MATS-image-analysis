...
RowBinCCD =  bin2dec(header_bin(3,8));
NRowBinCCD = bin2dec(header_bin(3,11:16));
NRowSkip = bin2dec(header_bin(4,9:16));
NCol = bin2dec(header_bin(5,:));
ColBinFPGA= bin2dec(header_bin(6,1));
ColBinCCD = bin2dec(header_bin(6,2));
...
% disp(['Col: ' header_bin(6,:) ' Row: ' header_bin(3,:)])
% Read image
