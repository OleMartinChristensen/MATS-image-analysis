...
% Bad column analysis
[n_read, n_coadd] = binning_bc(header.NCol + 1,header.NColSkip,2^header.NColBinFPGA,header.NColBinCCD,header.BadCol);
...
for j_c=1:header.NCol + 1
    ...
    true_image(1:header.NRow,j_c)= true_image(1:header.NRow,j_c) * (2^header.NColBinFPGA*header.NColBinCCD/n_coadd(j_c));
end
